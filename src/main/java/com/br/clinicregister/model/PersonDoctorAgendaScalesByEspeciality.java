...
@Getter
public enum PersonDoctorAgendaScalesByEspeciality {
    ...
    */
    ...
    PersonDoctorAgendaScalesByEspeciality(String hour, String day, String especiality) {
        this.hour = hour;
        this.day = day;
    ...
    public static void main(String[] args) {
        ArrayList<String> horarioDoDoutorTerca = new ArrayList<String>();
        ArrayList<Boolean> disponivelDoutorTerca = new ArrayList<Boolean>();
        ArrayList<Integer> posicaoDoHorarioTerca = new ArrayList<Integer>();


        for (PersonDoctorAgendaScalesByEspeciality nomes : PersonDoctorAgendaScalesByEspeciality.values()) {
            ArrayList<Integer> test = new ArrayList<Integer>();
            if ((nomes.getEspeciality() == "Cardiology") && (nomes.getDay() == "Tuesday")) {
                horarioDoDoutorTerca.add(nomes.getHour());
                disponivelDoutorTerca.add(true);
                ;
            }

        }

        String consultHourRequest = "09:00 AM";
        String consultDateRequest = "Tuesday";
        Boolean testador = false;


        Integer posicao = horarioDoDoutorTerca.indexOf(consultHourRequest);
