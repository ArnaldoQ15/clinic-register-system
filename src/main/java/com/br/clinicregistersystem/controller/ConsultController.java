...
//    (GET) Find consults by Person ID
    ...
    public Consult addConsult(@RequestBody Consult consult, @Valid @PathVariable Long personId, Doctor doctor,
                              DoctorHourMonday doctorHourMonday, DoctorHourTuesday doctorHourTuesday,
...
//                doctorHourFriday, doctorHourSaturday);
        ...
        return consultService.saveConsult(consult, doctor, doctorHourMonday, doctorHourTuesday, doctorHourWednesday, doctorHourThursday,
                doctorHourFriday, doctorHourSaturday);
    }
